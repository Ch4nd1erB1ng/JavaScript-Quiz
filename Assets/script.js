  ...
  var timeLeft = 10;
  var element = document.getElementById('time-div');
  var questionId = document.getElementById("?");
 ...
 {
     id: "0",
         questionId: "What is the correct syntax to declare a JavaScript variable?",
         answersId: ["var x = 10;", 
         "variable x = 10;", "x = 10;", 
         "let x = 10;"],
         correct: "var x = 10;"
     ...
     {
         id: "1",
         questionId: "What does the '===' operator in JavaScript do?",
         answersId: ["Compares the values of two variables, but not their types.", "Compares the values and types of two variables.", "Assigns a value to a variable.", "None of the above."],
         correct: "Compares the values and types of two variables."
     },
     {
         id: "2",
         questionId: "Which of the following methods can be used to add a new element to the end of an array in JavaScript?",
         answersId: ["array.pop()", "array.shift()", "array.push()", "array.unshift()"],
         correct: "array.push()"
     },
     {
         id: "3",
         questionId: "What is the output of the following code snippet?\n\nconsole.log(3 + 4 + '5');",
         answersId: ["345", "12", "75", "NaN"],
         correct: "75"
     },
     {
         id: "4",
         questionId: "What is the output of the following code snippet?\n\nlet a = 5;\nlet b = 7;\n[a, b] = [b, a];\nconsole.log(a, b);",
         answersId: ["5 7", "7 5", "undefined undefined", "TypeError"],
         correct: "7 5"
     }
]    
  ...
  function countdown() {
    if (timeLeft == -1) {
      ...
      timeOver();
      // Call the function you want to execute when the timer reaches zero
      doSomething();
    } else {
  ...
  button.addEventListener("click", function() {
    // Start the countdown and timer when the button is clicked
  ...
  // Add the function doSomething() if it's not defined
  function doSomething() {
    // Your logic here
    console.log("Timer reached zero. Do something!");
  }
